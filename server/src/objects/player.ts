...
export class PlayerBarn {
    ...
    addPlayer(socketData: PlayerContainer, joinMsg: JoinMsg) {
        ...
        */
        ...
        //Loaded ammo when spawn and loadout gun
        ...
        // comment so i dont forget where it ends
...
export class Player extends BaseGameObject {
    ...
    constructor(
        ...
        this.inventory["4xscope"] = 1;
        this.inventory[this.scope] = 1;

        //Scope
        this.inventory["1xscope"] = 1;
        this.inventory["2xscope"] = 1;
        this.inventory["3xscope"] = 1;
        this.inventory[this.scope] = 1;
        
        //Ammo
        this.inventory["9mm"] = 420;
        this.inventory["762mm"] = 300;
        this.inventory["556mm"] = 300;
        this.inventory["12gauge"] = 90;
        this.inventory["50AE"] = 196;
        this.inventory["308sub"] = 45;
        this.inventory["45acp"] = 300;
        
        //Heal
        this.inventory["bandage"] = 30;
        this.inventory["healthkit"] = 4;
        this.inventory["soda"] = 15;
        this.inventory["painkiller"] = 4;
    }
